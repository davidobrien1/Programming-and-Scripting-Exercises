...
# Exercise Description: Write a Python script containing a function called 
...
def factorial(x):   # this line defines the function 'factorial' where x is the input value
  ...
  return factorialx     # returns the final value of factorialx after going through all values in the for loop
