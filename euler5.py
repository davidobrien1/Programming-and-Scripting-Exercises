...
# Reference and code taken from: https://code.mikeyaworski.com/python/project_euler/problem_5
# Exercise Description: 2520 is the smallest number that can be divided by each of the numbers from 1 to 10 without any remainder.
